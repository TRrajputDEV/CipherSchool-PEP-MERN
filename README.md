...
- Skills and achievements section for quick profiling
- Contact form for direct communication
- Modern UI with gradient-based design and smooth transitions

**Tech Stack:**  
`HTML` `CSS3` `Responsive Design` `FlexBox` `Grid`
...
- Instant result display with decimal precision
...
**Features:**
- Fetch all student records using REST endpoints
- Retrieve individual student details by ID
- Create new student entries with validation
- Update existing student information
- Delete student records dynamically
- Persistent storage using JSON file system

**Tech Stack:**  
`Node.js` `Express.js` `JavaScript` `Postman` `File System (fs)` ` JSON`
